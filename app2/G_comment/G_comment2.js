		...
		<ul class="ul1">\
			<li>\
				...
				<div>\
					<img src="../img/user/user.jpg"/>\
					<h4>user01 <span> 删除</span></h4>\
					<p> <span>回复-user2 : </span>content! content!content! content!</p>\
					<a href="#textarea" name="oid">回复</a>\
				</div>\
				<div>\
					<img src="../img/user/user.jpg"/>\
...
G_comment.STATE={
	//state : 'off',
	paths:{
		ajaxURL1:'/ajax/book/comment',
		ajaxURL2:'/ajax/book/comment/del',
	}
}
...
$("#comment>button").click(function(e) {
	var book_id=$("#comment>span").text()
	var content=$("#comment>textarea").val()
	
	
	$.post(state.paths.ajaxURL1,{book_id:book_id,content:content,comment_id:comment_id,to:to},function(result){
